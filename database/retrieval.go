...
// RetrievePostByUUID TODO
func RetrievePostByUUID(uuid string) (*structure.Post, error) {
	// Retrieve post
	row := readDB.QueryRow(stmtRetrievePostByUUID, uuid)
	return extractPost(row)
}

// RetrievePostByID TODO
func RetrievePostByID(postID int64) (*structure.Post, error) {
	// Retrieve post
	row := readDB.QueryRow(stmtRetrievePostByID, postID)
	return extractPost(row)
}

// RetrievePostBySlug TODO
...
// RetrievePrevPostByPublicationDate TODO
...
// RetrieveNextPostByPublicationDate TODO
...
// RetrieveNumberOfPostsByUser TODO
...
// RetrieveNumberOfPostsByTag TODO
...
// RetrieveUser TODO
func RetrieveUser(userID int64) (*structure.User, error) {
	user := structure.User{}
	// Retrieve user
	row := readDB.QueryRow(stmtRetrieveUserByID, userID)
...
// RetrieveHashedPasswordForUser TODO
